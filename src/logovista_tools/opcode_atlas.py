...
CONTROL_SPECS: dict[int, ControlSpec] = {
    ...
    0x04: ControlSpec("04", 0, "style", "generic style/text span start", pair_role="start", pair="05"),
    0x05: ControlSpec("05", 0, "style", "generic style/text span end", pair_role="end", pair="04"),
    ...
    0xE2: ControlSpec("e2", 2, "style", "color/style start", pair_role="start", pair="e3", semantic_confidence="low"),
    0xE3: ControlSpec("e3", 0, "style", "color/style end", pair_role="end", pair="e2", semantic_confidence="low"),
}
